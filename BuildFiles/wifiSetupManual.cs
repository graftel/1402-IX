...
namespace Neo.ApplicationFramework.Generated {
    ...
    public partial class wifiSetupManual : Neo.ApplicationFramework.Controls.Controls.Form {
        ...
        private bool m_Initialized_wifiSetupManual;
        
        public wifiSetupManual() {
            this.InitializeComponent();
            this.Adapter.Closed += new System.EventHandler(this.wifiSetupManual_Closed);
            this.Adapter.Opened += new System.EventHandler(this.wifiSetupManual_Opened);
        ...
        private void InitializeComponent() {
            ...
            this.m_Text.ScreenOwnerName = "wifiSetupManual";
            this.m_Text.Top = 101;
            ...
            this.m_btnOK.ScreenOwnerName = "wifiSetupManual";
            ...
            this.m_LinearMeter.ScreenOwnerName = "wifiSetupManual";
            ...
            this.m_Text2.ScreenOwnerName = "wifiSetupManual";
            this.m_Text2.Top = 62;
            this.m_Text2.VisibleDynamicsValue = true;
            this.m_Text2.Width = 190;
            // 
            // m_Text3
            // 
            ...
            this.m_Text3.ScreenOwnerName = "wifiSetupManual";
            ...
            this.m_Text1.ScreenOwnerName = "wifiSetupManual";
            ...
            this.Name = "wifiSetupManual";
            this.PopupScreen = false;
            this.ScreenID = null;
            this.ScreenTitle = "";
            this.StyleName = "";
            this.WindowState = System.Windows.Forms.FormWindowState.Normal;
            this.m_Initialized_wifiSetupManual = true;
        ...
        public override void AddControlsAndPrimitives() {
            if (!m_Initialized_wifiSetupManual) {
                return;
            }
            this.AddControls();
        ...
        private void ApplyLanguageInternal() {
            Neo.ApplicationFramework.Tools.MultiLanguage.MultiLanguageResourceManager resources = new Neo.ApplicationFramework.Tools.MultiLanguage.MultiLanguageResourceManager(typeof(wifiSetupManual));
            this.m_Text.Text = resources.GetText("wifiSetupManual.Text.Text", "Connecting to Access Point, please wait...");
            this.m_btnOK.Text = resources.GetText("wifiSetupManual.btnOK.Text", "OK");
            this.m_Text2.Text = resources.GetText("wifiSetupManual.Text2.Text", "Setting up parameters, please wait...");
            this.m_Text3.Text = resources.GetText("wifiSetupManual.Text3.Text", "Status:");
            this.m_Text1.Text = resources.GetText("wifiSetupManual.Text1.Text", "Setting up manual parameters");
