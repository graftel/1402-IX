...
namespace Neo.ApplicationFramework.Generated {
    ...
    public partial class WifiSetupSoftAP : Neo.ApplicationFramework.Controls.Controls.Form {
        ...
        private bool m_Initialized_WifiSetupSoftAP;
        
        public WifiSetupSoftAP() {
            this.InitializeComponent();
            this.Adapter.Closed += new System.EventHandler(this.WifiSetupSoftAP_Closed);
            this.Adapter.Opened += new System.EventHandler(this.WifiSetupSoftAP_Opened);
            this.Opened += new System.EventHandler(this.WifiSetupSoftAP_Action_Opened);
        ...
        private void InitializeComponent() {
            ...
            this.m_Text.ScreenOwnerName = "WifiSetupSoftAP";
            this.m_Text.Top = 101;
            ...
            this.m_btnOK.ScreenOwnerName = "WifiSetupSoftAP";
            ...
            this.m_LinearMeter.ScreenOwnerName = "WifiSetupSoftAP";
            ...
            this.m_Text1.ScreenOwnerName = "WifiSetupSoftAP";
            ...
            this.m_Text2.ScreenOwnerName = "WifiSetupSoftAP";
            this.m_Text2.Top = 62;
            this.m_Text2.VisibleDynamicsValue = true;
            this.m_Text2.Width = 168;
            // 
            // m_Text3
            // 
            ...
            this.m_Text3.ScreenOwnerName = "WifiSetupSoftAP";
            ...
            this.Name = "WifiSetupSoftAP";
            this.PopupScreen = false;
            this.ScreenID = null;
            this.ScreenTitle = "";
            this.StyleName = "";
            this.WindowState = System.Windows.Forms.FormWindowState.Normal;
            this.m_Initialized_WifiSetupSoftAP = true;
        ...
        public override void AddControlsAndPrimitives() {
            if (!m_Initialized_WifiSetupSoftAP) {
                return;
            }
            this.AddControls();
        ...
        private void WifiSetupSoftAP_Action_Opened(object sender, System.EventArgs e) {
            Neo.ApplicationFramework.Generated.Globals.AuditTrailService.LogAction("WifiSetupSoftAP", "Opened", "Set Analog", "Tags.CurrentScreen", "");
            Neo.ApplicationFramework.Generated.Globals.Tags.CurrentScreen.SetAnalog(49);
        }
        ...
        private void ApplyLanguageInternal() {
            Neo.ApplicationFramework.Tools.MultiLanguage.MultiLanguageResourceManager resources = new Neo.ApplicationFramework.Tools.MultiLanguage.MultiLanguageResourceManager(typeof(WifiSetupSoftAP));
            this.m_Text.Text = resources.GetText("WifiSetupSoftAP.Text.Text", "Connecting to Access Point, please wait...");
            this.m_btnOK.Text = resources.GetText("WifiSetupSoftAP.btnOK.Text", "OK");
            this.m_Text1.Text = resources.GetText("WifiSetupSoftAP.Text1.Text", "Setting up soft AP");
            this.m_Text2.Text = resources.GetText("WifiSetupSoftAP.Text2.Text", "Setting up soft AP, please wait...");
            this.m_Text3.Text = resources.GetText("WifiSetupSoftAP.Text3.Text", "Status:");
