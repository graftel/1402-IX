...
namespace Neo.ApplicationFramework.Generated {
    ...
    public partial class FilterHigh : FilterBack {
        ...
        private bool m_Initialized_FilterHigh;
        
        public FilterHigh() {
            this.InitializeComponent();
            this.Opened += new System.EventHandler(this.FilterHigh_Action_Opened);
        ...
        private void InitializeComponent() {
            ...
            this.m_Button8.VisualPropertiesHashCode = -1528402670;
            ...
            this.m_Initialized_FilterHigh = true;
        ...
        private void FilterHigh_Action_Opened(object sender, System.EventArgs e) {
            Neo.ApplicationFramework.Generated.Globals.AuditTrailService.LogAction("FilterHigh", "Opened", "Set Analog", "Tags.CurrentScreen", "");
            Neo.ApplicationFramework.Generated.Globals.Tags.CurrentScreen.SetAnalog(17);
        }
        ...
        private void ApplyLanguageInternal() {
            Neo.ApplicationFramework.Tools.MultiLanguage.MultiLanguageResourceManager resources = new Neo.ApplicationFramework.Tools.MultiLanguage.MultiLanguageResourceManager(typeof(FilterHigh));
            this.m_Text5.Text = resources.GetText("FilterHigh.Text5.Text", "9 --> MAX ALLOWED FILTERING");
            this.m_Text6.Text = resources.GetText("FilterHigh.Text6.Text", "0 --> IMMEDIATE RESPONSE");
            this.m_Text7.Text = resources.GetText("FilterHigh.Text7.Text", "% FSR\nUPPER THRESHOLD");
            this.m_Text.Text = resources.GetText("FilterHigh.Text.Text", "High Range Filter Constant");
            this.m_Button8.Text = resources.GetText("FilterHigh.Button8.Text", "RESTORE\nDEFAULT");
